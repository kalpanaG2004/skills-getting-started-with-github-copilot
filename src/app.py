...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique training and lap practice at the school pool",
    ...
    "Drama Club": {
        "description": "Acting exercises, scene work, and theater productions",
    ...
    "Debate Team": {
        "description": "Prepare arguments and compete in inter-school debates",
